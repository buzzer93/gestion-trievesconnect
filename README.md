...
5. Change git remote url to avoid accidental pushes to base project
   ```sh
   git remote set-url origin buzzer93/gestion-trievesconnect
...
See the [open issues](https://github.com/buzzer93/gestion-trievesconnect/issues) for a full list of proposed features (and known issues).
...
<a href="https://github.com/buzzer93/gestion-trievesconnect/graphs/contributors">
  <img src="https://contrib.rocks/image?repo=buzzer93/gestion-trievesconnect" alt="contrib.rocks image" />
</a>
